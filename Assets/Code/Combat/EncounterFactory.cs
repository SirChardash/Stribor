...
namespace Code.Combat
{
  public class EncounterFactory
  {
    public Encounter CreateSample()
    {
      ...
      {
        new Character {Damage = 4, Health = 30, Speed = 5, Name = "mob11", Behavior = new ConstantAttack()},
        new Character {Damage = 6, Health = 15, Speed = 5, Name = "mob12", Behavior = new ConstantAttack()},
        new Character {Damage = 4, Health = 25, Speed = 7, Name = "mob13", Behavior = new ConstantAttack()}
      };
